...
//   // if (!state) {
//   //   return <p>data not come..</p>;
//   // }

//   useEffect(() => {
//     const singleItemCall = async () => {
//       try {
//         const data = await instance.get(`symbol?name=${state}`);
//         console.log('api data come', data);
//         setspecificItem(data);
//       } catch (error) {
...
//   //   return <p>Error</p>;
//   // }
//   // console.log('specificItem', specificItem?.data?.symbol);
...
//               {specificItem?.data?.symbol}
//             </p>
//             <p className="text-3xl font-bold">
//               {/* Revance <br /> Therapeutics */}
//               {specificItem?.data?.name}
//             </p>
//             <p className="text-3xl font-bold">
//               {' '}
//               ${specificItem?.data?.price?.price}{' '}
//             </p>
//           </div>
//           <div className="bg-gray-100 rounded-full">
//             <img
//               className="w-12 h-12 rounded-full object-contain"
//               src={specificItem?.data?.logo}
//               alt="revance"
//             />
//           </div>
//         </div>
...
//       {/* --- stock chart start --- */}
//       <section>
//         <StockBuyChart symbol={specificItem?.data?.symbol} />
//       </section>
//       {/* --- stock chart end --- */}
...
//         <button
//           onClick={() =>
//             navigate(`/buy/${specificItem?.symbol}`, {
//               state: { data: specificItem },
//             })
//           }
...
//       {/* --- stock details start --- */}
//       <section>
//         <StockAbout allspecificdata={specificItem?.data} />
//       </section>
//       {/* --- stock details end --- */}
