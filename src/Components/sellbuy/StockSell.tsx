...
//           <div>
//             <h2 className="text-2xl font-bold">Sell {symbol}</h2>
          ...
          <section className='mt-16 mb-5'>
            <div className="flex items-center justify-center  ">
              ...
              {gifSelected ? (
                ...
                <div className='rounded-s-lg py-7 bg-gray-100 text-center gif-preview w-40 h-20 mx-auto rounded-md' style={{backgroundImage : `url(${gifSelected?.url})`, backgroundSize : "cover"}}>
